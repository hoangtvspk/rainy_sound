...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool isAuthenticated, User? user, Status authStatus, Status userStatus});
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl(
      ...
      this.user = null,
      this.authStatus = const Status.idle(),
      this.userStatus = const Status.idle()});
  ...
  @override
  String toString() {
    return 'AuthState(isAuthenticated: $isAuthenticated, user: $user, authStatus: $authStatus, userStatus: $userStatus)';
  }
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      ...
      final User? user,
      final Status authStatus,
      final Status userStatus}) = _$AuthStateImpl;
